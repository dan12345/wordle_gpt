...
class SimpleAgent:
    ...
    def ai_message_to_guess(ai_message):
        return json.loads(ai_message.content)['guess'].replace(',', '').replace('[', '').replace(']', '')
...
2. In case you got a 'G' which indicates right letter in right position - try to guess the same letter in the same position again. 
3. In case you got a _ which indicates wrong letter - try to guess a different letter in the same position.
4. In case you got a 'Y' which indicates right letter in wrong position - try to guess the same letter in a different position.
...
Note that if you guessed the same letter more than once and it appears more than once in the solution, you will get multiple Ys. If it appears only once, only the first instance will be counted as a Y. In case that one of the letters appears in the correct position, it will be prioritized as a G.
For example, if the word was scarf and you guessed sandy, the response would be GY___ - G because S was in the right position, Y because A was in the wrong position, while n,d and y were not in the word at all. 
...
For example, if the word was scarf and you guessed sandy, the response would be GY___ - G because 's' was in the word in the right position, Y because 'a' is in the solution but the wrong position, while n,d and y were not in the word at all.
...
Use the following format:
{"knowledge":"Letters I know appear in the word: [a (second), y (fifth), j (first or third)]\nLetters I know don't appear in the word: [b,c,d,e,h]\nLetters I am still unsure about: [f,s]", "reasoning": "your reasoning", "guess":" "your [g,u,e,s,s]"}
...
2. (second guess, no previous knowledge) 
Human: Your previous knowledge was - "Letters I know appear in the word: [] Letters I know don't appear in the word: [] Letters I am still unsure about: [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z]"
You guessed [c,a,n,d,y]. 
The evaluation was [_,G_,_,_,Y].
AI: {"knowledge":"Letters I know appear in the word: [a (second),y (first/third/fourth)], Letters I know don't appear in the word: [c,d,n], Letters I am still unsure about: [b,e,f,g,h,i,j,k,l,m,o,p,q,r,s,t,u,v,w,x,z]", "reasoning": "your reasoning", "guess": "[m,a,y,b,e]"}
 
3. (with previous knowledge)
Human: 
Your previous knowledge was - "Letters I know appear in the word: [e (second or fifth)], Letters I know don't appear in the word: [r,s,t], Letters I am still unsure about: [a,b,c,d,f,g,h,i,j,k,l,m,n,o,p,q,u,v,w,x,y,z]"
You guessed [b,a,r,o,n]. 
The evaluation was [_,G_,_,_,Y].
AI: {"knowledge":"Letters I know appear in the word: [a (second),e (fifth),n (second/third/fourth)], Letters I know don't appear in the word: [b,o,r,s,t], Letters I am still unsure about: [c,d,f,g,h,i,j,k,l,n,o,p,q,u,v,w,x,y,z]", "reasoning": "your reasoning", "guess": "[m,a,n,c,e]"}

4. (with previous knowledge)
Human: 
Your previous knowledge was - "Letters I know appear in the word: [i (second/fourth,o (second/fourth)], Letters I know don't appear in the word: [x,y,z], Letters I am still unsure about: [a,b,c,d,e,f,g,h,j,k,l,m,n,p,q,r,s,t,u,v,w]"
You guessed [p,i,l,o,t]. 
The evaluation was [_,G_,_,G,Y].
AI: {"knowledge":"Letters I know appear in the word: [i (second), o(fourth), t(first/third)], Letters I know don't appear in the word: [p,l,x,y,z] , Letters I am still unsure about: [a,b,c,d,e,f,g,h,j,k,m,n,q,r,s,u,v,w]", "reasoning": "your reasoning", "guess": "[r,i,o,t,s]"}
'''
